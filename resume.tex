...
\begin{ressection}{Skills}
  ...
  \begin{reslist}{Computer Languages:}
	\ressubitem{Currently using : PHP, Ruby, Javascript, Emacs Lisp and \LaTeX.}
    \ressubitem{Used in past : C, Java, and Python}
  \end{reslist}
  % Tools
  \begin{reslist}{Tools and Software:}
    \ressubitem{Tools : Linux tools, AWS, Emacs, collectd, statsd, etc}
    \ressubitem{Software : AWS SDK, Elasticsearch, Graphite, Nagios, etc.}
  \end{reslist}
  % END
\end{ressection}
...
\begin{ressection}{Hobbies and Interests}
  ...
  % \resitem{Avid reader of non-fiction writings.}
  \resitem{Supports E-sports amd plays Dota 2 and CS GO.}
  \resitem{Loves movies, TV series and anime.}
  % \resitem{Listens to music, particulary heavy metal music.}
\end{ressection}
